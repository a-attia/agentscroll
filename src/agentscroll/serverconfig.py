...
2. an environment variable (`AGENTSCROLL_HOST` / `AGENTSCROLL_PORT`)
3. the built-in default

This lets launchers (which just call `agentscroll web --window`) be
...
_ENV_HOST = "AGENTSCROLL_HOST"
_ENV_PORT = "AGENTSCROLL_PORT"
